...
section "This script will attempt to WithdrawRough for the contractor"
...
read -p "Enter amount Contractor wants to withdraw (this must match amount in DeployAdditional_6_ContractorWithdrawRough.hs [500000000]): " AMOUNT_TO_WITHDRAW
...
NEW_DATUM_FILE_NAME=6-deploy-contractor-withdraw-rough.json
NEW_DATUM_FILE_FULL_PATH=$PATH_TO_MILESTONE_DEPLOY/$NEW_DATUM_FILE_NAME

REDEEMER_FILE_NAME=redeemer-contractor-rough-payment.json
