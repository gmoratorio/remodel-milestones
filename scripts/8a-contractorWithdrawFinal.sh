...
section "This script will attempt to WithdrawFinal for the Contractor"
...
read -p "Enter amount Contractor wants to withdraw (this must match amount in DeployAdditional_8a_ContractorWithdrawFinal.hs [500000000]): " AMOUNT_TO_WITHDRAW
...
NEW_DATUM_FILE_NAME=8a-deploy-contractor-withdraw-final.json
NEW_DATUM_FILE_FULL_PATH=$PATH_TO_MILESTONE_DEPLOY/$NEW_DATUM_FILE_NAME

REDEEMER_FILE_NAME=redeemer-contractor-final-payment.json
