...
module Milestones.DeployAdditional_5_ContractorWithdrawDrywall where
...
-- This file DeployAdditional_5_ContractorWithdrawDrywall will be withdrawing the next payment for the contractor
...
writeMilestoneDatum = 
    ...
    in writeJSON "src/Milestones/Deploy/5-deploy-contractor-withdraw-drywall.json" d