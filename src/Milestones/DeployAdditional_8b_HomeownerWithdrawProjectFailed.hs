...
module Milestones.DeployAdditional_8b_HomeownerWithdrawProjectFailed where
...
-- This file DeployAdditional_8b_HomeownerWithdrawProjectFailed will be withdrawing funds for the Homeowner after a failed project that was ClosedIncomplete
...
totalWithdrawnHomeowner = 500_000_000
...
writeMilestoneDatum = 
    ...
    in writeJSON "src/Milestones/Deploy/8b-deploy-homeowner-withdraw-project-failed.json" d