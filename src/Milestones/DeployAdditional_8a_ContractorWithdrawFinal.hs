...
module Milestones.DeployAdditional_8a_ContractorWithdrawFinal where
...
-- This file DeployAdditional_8a_ContractorWithdrawFinal will be withdrawing the next payment for the contractor
...
lastContractorAction = OnChain.WithdrawFinalPayment
...
totalWithdrawnContractor = 2_000_000_000
...
writeMilestoneDatum = 
    ...
    in writeJSON "src/Milestones/Deploy/8a-deploy-contractor-withdraw-final.json" d