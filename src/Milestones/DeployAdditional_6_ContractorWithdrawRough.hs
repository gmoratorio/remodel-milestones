...
module Milestones.DeployAdditional_6_ContractorWithdrawRough where
...
-- This file DeployAdditional_6_ContractorWithdrawRough will be withdrawing the next payment for the contractor
...
lastContractorAction = OnChain.WithdrawRoughPayment
...
lastBalance :: Integer
lastBalance = 1_002_000_000

-- this value should reflect the new balance of withdrawing another 500ADA
totalWithdrawnContractor :: Integer
totalWithdrawnContractor = 1_000_000_000
...
writeMilestoneDatum = 
    ...
    in writeJSON "src/Milestones/Deploy/6-deploy-contractor-withdraw-rough.json" d